...
st.image('images/Here.jpeg', caption='Местоположение любого запуска ракеты')
...
st.image('images/cost.png', caption='Стоимость мечты всегда высока')
